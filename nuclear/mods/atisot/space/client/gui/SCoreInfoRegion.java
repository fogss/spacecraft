...
import nuclear.mods.atisot.space.client.util.SCoreUtil;
...
public class SCoreInfoRegion extends Gui
{
    protected int width;
    ...
    public SCoreInfoRegion(int par2, int par3, int par4, int par5, List<String> tooltipStrings, int parentWidth, int parentHeight)
    {
        this.width = 200;
        this.height = 20;
        this.enabled = true;
    ...
    {	
        ...
        if (this.drawRegion)
        {
            ...
            Gui.drawRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, SCoreUtil.convertTo32BitColor(100 * k, 255, 0, 0));
        }
        ...
        if (this.tooltipStrings != null && !this.tooltipStrings.isEmpty() && this.withinRegion)
        {
            ...
            this.zLevel = 300.0F;
            SCoreInfoRegion.itemRenderer.zLevel = 300.0F;
            int l1 = -267386864;
            ...
            this.zLevel = 0.0F;
            SCoreInfoRegion.itemRenderer.zLevel = 0.0F;
