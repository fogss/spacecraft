package nuclear.mods.atisot.space.generator;
...
public class SCoreOverworldGenerator implements IWorldGenerator
{
    ...
    public SCoreOverworldGenerator(Block oreBlock, int metadata, int amountPerChunk, int minGenLevel, int maxGenLevel, int amountPerVein)
    {
